...
public class addressBookAddMultipleContacts {
	...
	public static void main(String[] args) {
		...
		List<addressBookAddMultipleContacts> persons = new ArrayList<>();
		...
		if (userChoice == 0) {
			...
			for (int i = 0; i < noOfPersons; i++) {
				addressBookAddMultipleContacts contact = new addressBookAddMultipleContacts();
			...
			if (userChoice2 == 0) {
				...
				for (addressBookAddMultipleContacts i : persons) {
